					...
					<tbody>
						<c:forEach items="${cartInfo}" var="ci">
							<tr>
								...
								<td class="td_width_4 table_text_align_center"><button class="delete_btn" data-cartid="${ci.cartId}">삭제</button>
								</td>
							</tr>
						</c:forEach>
					</tbody>
...
$(document).ready(function(){
   ...
   $(".image_wrap").each(function(i, obj){
      ...
      if(bobj.data("bookid")){
         ...
         $(this).find("img").attr('src', '/resources/img/noim.png');
      }
