         ...
         <form action="/admin/goodsEnroll" method="post" id="enrollForm">
            ...
            <div class="form_section">
               ...
               <div class="form_section_content">
                  ...
                  <span class="ck_warn bookDiscount_warn">1~99 숫자의 할인 %를 입력해주세요</span>
               </div>
            </div>
            <div class="form_section">
               <div class="form_section_title">
            ...
            <div class="form_section">
               ...
               <div class="form_section_content">
            	...
            	<div class="form_section">
								...
								<img src="/display?fileName=cat01.png">-->
								</div>
                    			</div>
                    		</div>  
         </form>
...
//카테고리 리스트를 제이슨형식으로 string 으로 콘솔창 찍어본것 
//$().ready(function(){
